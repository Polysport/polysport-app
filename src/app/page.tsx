          ...
          <div className="flex flex-col justify-between gap-y-5 max-lg:items-center absolute bottom-0 xl:bottom-1/2 left-1/2 xl:left-[10%] -translate-x-1/2 xl:translate-x-0 xl:translate-y-1/2">
            ...
            >
              ...
              <div className="max-sm:h-[30px] brightness-50 h-[40px] aspect-square">
                <img className="w-full h-full" src="/assets/images/ETH.svg" />
              </div>
              <div className="max-sm:h-[30px] brightness-50 h-[40px] aspect-square">
                <img className="w-full h-full" src="/assets/images/BNB.svg" />
              </div>
              <div className="max-sm:h-[30px] brightness-50 h-[40px] aspect-square">
                <img
                  className="w-full h-full"
          ...
          <div className="mt-10 max-sm:mt-5 grid grid-cols-2 gap-10 max-sm:gap-5 max-lg:grid-cols-1 place-items-center overflow-auto">
            <div className="relative grid place-items-center max-w-[650px] min-h-[300px] max-sm:min-h-[250px] border-btn">
              <div className="flex flex-col p-10 pb-5 max-sm:p-5">
                <div className="flex items-center gap-x-[30px] max-sm:gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="line-clamp-6 max-sm:text-[12px]">
                      Marketplace provides a platform where users can buy and
                      sell various NFTs with each other. Users can set the price
                      of their own NFTs and initiate sales orders. Buyers can
                ...
                >
                  <p className="text-end max-sm:text-[12px]">Read</p>
              ...
              <div className="flex flex-col p-10 pb-5 max-sm:p-5">
                <div className="flex items-center gap-x-[30px] max-sm:gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="line-clamp-6 max-sm:text-[12px]">
                      There are 200 NFTs representing players from the world's
                      top soccer teams.
                      <br />
                      <br />
                      NFTs will be divided into 5 categories with different
                      colors from 1 star to 5 stars depending on the rarity of
                      the NFTs.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col p-10 pb-5 max-sm:p-5">
                <div className="flex items-center gap-x-[30px] max-sm:gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="line-clamp-6 max-sm:text-[12px]">
                      Burn your NFT minted from Box to receive amount of
                      flipping cards and have chances to get huge rewards if you
                      are lucky.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-10 max-sm:p-5 flex items-center gap-10 lg:gap-x-20 max-md:flex-col max-md:justify-center">
                ...
                <div className="flex-1 pt-[calc(66%)] md:pt-0 md:pl-[50%]">
                  <p>
                    ...
                    from and you WIN the amount in the lucky box. Pick any box
                    from 1-50 to win instantly by using an NFT. Winners can earn
                    real money, making it a lucrative platform for players with
                    the best cards. Polysport works on the Polygon block chain
