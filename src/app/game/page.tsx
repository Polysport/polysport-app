...
export default function GamePage() {
    ...
    return (
        <div>
            <section className="desktop:px-32 mobile:px-4 relative overflow-hidden">
                {/* banner */}
                ...
                <section className="flex desktop:gap-8 mobile:gap-2 mobile:flex-col desktop:flex-row relative">
                    ...
                    <div className="grow-[3] overflow-auto flex flex-col items-center">
                        <div className="w-full">
                            <section className="flex desktop:gap-4 mobile:gap-2 desktop:items-end mobile:items-center mt-4 mobile:flex-col desktop:flex-row">
                        ...
                        <section className="hidden mt-4 md:grid grid-cols-10 gap-2 min-w-[800px]">
                        ...
                        <section className="mt-4 grid md:hidden grid-cols-4 place-items-center gap-2 w-full">
