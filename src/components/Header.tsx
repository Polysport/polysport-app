...
export default function Header() {
  ...
  return (
    <div className="relative">
      ...
      {/* Header */}
      <div className="fixed top-0 left-0 w-screen py-5 z-[10] px-2 backdrop-blur-md mx-auto">
        <div className="max-w-[1280px] mx-auto">
          <div className="absolute flex gap w-[50%] max-w-[800px] max-lg:hidden justify-between h-full top-0 left-1/2 -translate-x-1/2">
          ...
          <div className="w-full flex justify-between items-center max-w-[1440px] mx-auto">
            <div className="flex gap-1 items-center">
              ...
              <p className="max-[500px]:hidden italic font-extrabold text-[26px] text-gray-400">
                POLYSPORT
              </p>
            </div>
