    ...
    <div className="bg-[#131313]">
      <div className="max-w-[1280px] mx-auto px-[22px] py-[49px]  grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-y-[24px] md:gap-x-[32px] xl:gap-x-[40px]">
        ...
        <div className="md:col-span-2 xl:col-span-3 grid md:grid-cols-2 xl:grid-cols-3">
          ...
          <div>
            ...
            <div className="flex gap-x-[29px]">
              ...
              >
                <Image src="/assets/telegram.svg" alt="icon" fill sizes="any" />
              </Link>
              <Link
                ...
                className="h-[26px] aspect-square relative"
              >
                <Image src="/assets/X.svg" alt="icon" fill sizes="any" />
              </Link>
              ...
              <Link
                ...
                className="h-[26px] aspect-square relative"
              >
                <Image src="/assets/discord.svg" alt="icon" fill sizes="any" />
              </Link>
              <Link
                ...
                className="h-[26px] aspect-square relative"
              >
                <Image src="/assets/medium.svg" alt="icon" fill sizes="any" />
              </Link>
              ...
              <Link
                ...
                className="h-[26px] aspect-square relative"
              >
                <Image src="/assets/github.svg" alt="icon" fill sizes="any" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <p className="md:col-span-3 xl:col-span-4 text-[12px] md:text-[16px] text-center opacity-70 font-medium">
          {new Date().getFullYear()} © Copyright POLYSPORT. All Rights Reserved
        </p>
      </div>
    </div>
  );
